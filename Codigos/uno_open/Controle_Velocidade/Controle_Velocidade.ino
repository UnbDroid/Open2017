...
void loop() {
   ...
   if (millis() - tempo > 20) 
   {
    ...
    /*
      ...
      Serial.print("Voltas esquerda: ");      Serial.println(voltas_esquerda);
      Serial.print("Voltas direita: ");       Serial.println(voltas_direita);
      Serial.println(" ");
      */    
  ...
  if (Serial.available() > 0) 
  {
    ...
    velocidade_ReferenciaEsquerda = velocidade_ReferenciaDireita * 1.13;//alteração para o robô poder andar mais reto
